...
namespace ProductosApp
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            builder.RegisterType<pratica.pratica.ProductoRepositorio>().As<pratica.pratica.IProductorepositorio>();
            Application.Run(new fmrdemos(container.Resolve<pratica.pratica.IProductorepositorio>()));
            Ap
        }
    }
}
